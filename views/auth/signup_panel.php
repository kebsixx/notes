    ...
    <form method="post" action="signup.php" class="auth-form">
        <div class="auth-field">
            ...
            <div class="auth-input-wrap">
                <input class="auth-input" id="signup_username" name="signup_username" type="text" autocomplete="username" value="<?php echo htmlspecialchars($signupUsername, ENT_QUOTES, 'UTF-8'); ?>" required>
        ...
        <div class="auth-field">
            <label class="auth-label" for="signup_password"><span>Password</span></label>
            <div class="auth-input-wrap">
                <input class="auth-input" id="signup_password" name="signup_password" type="password" autocomplete="new-password" required>
                <button class="auth-icon auth-icon-button" type="button" data-toggle-password data-target="signup_password" aria-label="Show password" aria-pressed="false">
                    ...
                    <svg class="auth-icon-svg auth-icon-svg-eye-off" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
        ...
        <div class="auth-field">
            <label class="auth-label" for="signup_confirm"><span>Konfirmasi Password</span></label>
            <div class="auth-input-wrap">
                <input class="auth-input" id="signup_confirm" name="signup_confirm" type="password" autocomplete="new-password" required>
                <button class="auth-icon auth-icon-button" type="button" data-toggle-password data-target="signup_confirm" aria-label="Show password" aria-pressed="false">
                    <svg class="auth-icon-svg auth-icon-svg-eye" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                        <path d="M12 5c5.52 0 9.8 4.05 11 7-1.2 2.95-5.48 7-11 7S2.2 14.95 1 12c1.2-2.95 5.48-7 11-7Zm0 2C7.79 7 4.35 9.74 3.17 12 4.35 14.26 7.79 17 12 17s7.65-2.74 8.83-5C19.65 9.74 16.21 7 12 7Zm0 2.5A2.5 2.5 0 1 1 9.5 12 2.5 2.5 0 0 1 12 9.5Z"/>
                    </svg>
                    <svg class="auth-icon-svg auth-icon-svg-eye-off" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
